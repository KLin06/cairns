...
def build_dashboard(counts, examples, sample_size, out_path):
    ...
    ax.set_ylabel("score")
    ax.set_title(
        f"Condition detector vs manually labeled reviews — trail {TRAIL_ID}, n={sample_size} reviews"
    )
...
if __name__ == "__main__":
    ...
    out_path = os.path.join(DATASETS_DIR, "dashboards", "condition_f1_dashboard.png")
